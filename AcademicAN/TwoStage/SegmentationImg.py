...
PATH_TO_LABELS = 'annotations/label_map2.pbtxt'
NUM_CLASSES = 4
IMAGE_SIZE = (48, 32)
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph, config=config) as sess:
        ...
        xml_list = read_xml('./SegTest/陈胜球-右-斑块-横切.xml')
        ...
        precision, recall = metrics.compute_precision_recall(scores[1], tp_fp_labels[1], 2)
        print(scores)
        print('---------')
